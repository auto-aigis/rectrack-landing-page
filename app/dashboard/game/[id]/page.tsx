...
export default function GameDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    ...
    if (isPro) {
      gamesApi.getInsight(id).then(setTip).catch(() => {}).finally(() => setTipLoading(false));
    } else {
      setTipLoading(false);
    }
  }, [id, isPro]);
      ...
      <div className="p-4 md:p-6 max-w-2xl mx-auto space-y-5">
        ...
        {game.feeling_notes && (
          <Card>
            ...
            <CardContent className="pt-0">
              <p className="text-gray-700 text-sm leading-relaxed">{game.feeling_notes}</p>
            </CardContent>
          </Card>
        )}
            ...
            <CardContent className="pt-0">
              {tipLoading ? (
                <div className="flex items-center gap-2 text-blue-600">
                  ...
                  <span className="text-sm">Generating your tip...</span>
                </div>
              ) : tip ? (
          ...
          <Card className="border-gray-200">
            <CardContent className="py-6 text-center space-y-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">Get personalized GPT-4o coaching tips after every game</p>
              </div>
